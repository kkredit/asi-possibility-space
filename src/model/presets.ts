...
export const presets: KnownPreset[] = [
...

  {
    ...
    references: [
      ...
      { label: 'Statement on the Department of War\'s ultimatum (Future of Life Institute, 2026)', url: 'https://futureoflife.org/ai/tegmark-statement-on-dow-ultimatum/', quote: `"Fully autonomous weapons systems and Orwellian AI-enabled domestic mass surveillance" are "affronts to our dignity and liberty"; "all AI systems should be under meaningful human control."` },
    ],
    factors: {
      ...
      coordination: { accuracy: 0.85, refs: [3, 4, 6], note: 'The core of his position: organized the 2023 pause letter and the 2025 Statement on Superintelligence, both calling for a binding prohibition until safety and public buy-in exist, and continues pressing red lines (autonomous weapons, domestic mass surveillance) into 2026.' },
...

  {
    ...
    references: [
      ...
      { label: 'Q1 2026 Timelines Update (AI Futures Project, 2026)', url: 'https://blog.aifutures.org/p/q1-2026-timelines-update', quote: `His Automated Coder median moved from late 2029 to mid 2028: "progress in agentic coding has been faster than we expected over the last 3-5 months."` },
    ],
    factors: {
      ...
      takeoff: { accuracy: 0.9, refs: [2, 9], note: `Explicit: a software-driven intelligence explosion, ~1-year median from superhuman coder to ASI (with wide error bars); his Automated Coder median itself moved up from late 2029 to mid 2028 in early 2026.` },
...

  {
    ...
    factors: {
      orthogonality: { accuracy: 0.7, refs: [5], note: `Cites the orthogonality thesis + instrumental convergence as the core arguments for AI being the top existential risk.` },
...

  {
    ...
    category: 'person',
    affiliation: 'ARC',
    role: 'ARC founder & executive director; OpenAI Foundation Board; part-time US CAISI adviser',
    summary:
    ...
    references: [
      ...
      { label: 'Paul Christiano joins OpenAI Foundation Board (OpenAI, 2026)', url: 'https://openai.com/index/paul-christiano-joins-openai-foundation-board/', quote: `Joins the Foundation Board's Safety and Security Committee and a non-voting observer seat on the OpenAI Group PBC board, while remaining ARC's executive director and a part-time senior technical adviser to CAISI.` },
    ],
    factors: {
...

  {
    ...
    factors: {
      ...
      takeoff: { accuracy: 0.7, refs: [3], note: `Fast-ish/near: superintelligence in "five and 20 years"; revised his timelines substantially downward, surprised by the pace.` },
...

  {
    ...
    references: [
      ...
      { label: 'Ted Cruz on Musk\'s 10-20% estimate (TMZ, 2026)', url: 'https://www.tmz.com/2026/09/09/ted-cruz-says-elon-musk-gave-him-probability-of-ai-destroying-humans/', quote: `Cruz recounts Musk privately giving the same "10% to 20%" chance of "killer robots annihilating humanity," with a possible timeframe of "5 to 10 years."` },
    ],
    factors: {
      ...
      alignmentInTime: { accuracy: 0.5, refs: [2, 7], note: `Net-optimistic ("most likely going to be great") but assigns 10–20% catastrophe, reconfirmed privately to Sen. Cruz with a possible 5-10 year window; no firm claim aligned ASI arrives first.` },
...

  {
    ...
    references: [
      ...
      { label: 'The Future Is for Everyone (Mark Zuckerberg, Meta, 2026)', url: 'https://about.fb.com/news/2026/08/the-future-is-for-everyone/', quote: `Names "individual empowerment as the source of prosperity, invention as the primary purpose of superintelligence, and balance of power as the foundation of safety."` },
    ],
    factors: {
      ...
      powerConcentration: { accuracy: 0.9, refs: [1, 6, 7], note: `Explicitly diffuse: open source so "power isn't concentrated in the hands of a small number of companies"; Zuckerberg's 2025 memo adds "there is no such thing as a singular benevolent superintelligence," and his 2026 essay names "balance of power as the foundation of safety."` },
