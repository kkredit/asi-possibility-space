...
export const presets: KnownPreset[] = [
...

  {
    ...
    factors: {
      ...
      takeoverSeverity: { accuracy: 0.3, note: 'Core Views spans scenarios from easy to catastrophic without adjudicating severity; sleeper-agents-era writing treats both terminal and lock-in outcomes as live.' },
